    ...
    <div>
      <div className=" w-screen  flex px-6  ">
        <div className=" card rounded-lg bg-base-100 border border-base-200 shadow-xl px-3 my-10 w-full">
          <h1 className=" text-xl text-center mb-5 mt-5">
            ...
            <div className="w-full">
              ...
              <div className=" flex items-center justify-end py-6 px-3">
                <input
                  ...
                  name="date"
                  id=""
                  className=" input input-xs input-accent mx-2"
                />
                <select
                  name="classes"
                  className=" input input-xs w-32 input-accent "
                  required
                  id=""
                >
                ...
                <button
                  type="submit"
                  className=" btn btn-sm btn-info text-base-100 mx-7"
                >
                  Create
                </button>
                <a
