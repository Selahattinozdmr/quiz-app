      ...
      <div className=" flex w-full h-full">
        <div className=" quizz w-[170px] h-full border-r- shadow-xl border-gray-300 px-3 ">
          ...
          <div className=" my-10 h-full">
            <Link
              href={"/teacher-page/create-quiz"}
              className="w-full block text-sm text-gray-700 hover:text-black my-6"
            >
              Create Quiz
            </Link>
            <Link
              href={"/teacher-page/create-question"}
              className=" w-full block text-sm text-gray-700 my-6 hover:text-black"
            >
              Create Question
            </Link>
            <Link
              href={"/teacher-page/edit-question"}
              className=" w-full block text-sm text-gray-700 my-6 hover:text-black"
            >
              Edit Question
            </Link>
        ...
        <div className=" w-full">
          <div className=" px-5 flex justify-between w-full">
            ...
            <a href="/teacher-page/create-quiz" className=" btn bg-gray-200">
              {" "}
              <p className=" text-xl">+</p> Add Quiz {}
            </a>
          </div>
          ...
          <div className=" flex p-5">
            <div className="card rounded-lg bg-base-100 border border-base-200 shadow-xl w-2/4 mx-3 h-[600px] p-5">
              ...
              <div className=" bg-green-200 flex justify-between py-6 px-14 items-center rounded-2xl my-3">
                <div className=" bg-green-500 text-base-100 p-3 rounded-lg">
                  {e}
                </div>
                <p className=" text-lg font-bold ">Last Quiz </p>
                <a
                  href="/teacher-page/quiz-list"
