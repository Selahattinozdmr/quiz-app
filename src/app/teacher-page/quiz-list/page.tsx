  ...
  return (
    <div>
                    ...
                    <tr key={item.id}>
                      ...
                      <td className=" flex">
                        <form action={approveQuiz}>
                          ...
                          />
                          <button className="mx-1 btn btn-xs btn-accent">
                            Approve
                          </button>
                        </form>
                        <a
                          href={"/teacher-page/quiz-list/" + item.id}
      ...
      <div className=" flex justify-end p-3">
        <a href="/teacher-page/create-quiz" className=" btn btn-accent">
          Go Back
        </a>
      </div>
    </div>
